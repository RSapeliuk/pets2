...
let LoginationComponent = class LoginationComponent {
...
LoginationComponent.ctorParameters = () => [
...
class Post {
    constructor(title, kind, photo, date, expirationDate, optional_field) {
        this.title = title;
        this.kind = kind;
        this.photo = photo;
        this.date = date;
...
let PostService = class PostService {
    ...
    savePost(userPost, user) {
        ...
        return this.http.post(this.url + user.id, userPost, { headers });
    }
};
